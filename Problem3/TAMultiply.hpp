...
public:
	// TAMultiply constructors take and save two references to numbers: either two TAInt or two TADouble objects
	// Names are optional
	...
	// This function multiplies the two numbers declared in the constructor, and saves the result/state
	void evaluate();
